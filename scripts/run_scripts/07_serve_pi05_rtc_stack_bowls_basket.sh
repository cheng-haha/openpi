...
CONFIG_NAME="${CONFIG_NAME:-pi05_rtc_stack_bowls_basket}"
CHECKPOINT_DIR="${CHECKPOINT_DIR:-./checkpoints/pi05_base_full_dual_arm_stack_bowls_basket/stack_bowls_basket_pi05_vla0_4gpu_20260525/10000}"
PORT="${PORT:-8000}"
