...
CHECKPOINT_STEP="${CHECKPOINT_STEP:-99999}"
...
if [[ ! -f "$CHECKPOINT_DIR/assets/openpi/y1_dual_arm_mixed_20260526/norm_stats.json" ]]; then
  echo "Missing checkpoint norm stats: $CHECKPOINT_DIR/assets/openpi/y1_dual_arm_mixed_20260526/norm_stats.json" >&2
  exit 1
fi
